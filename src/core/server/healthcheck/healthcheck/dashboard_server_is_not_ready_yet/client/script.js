...
class Icons {
  ...
  static get wazuhDashboard() {
    return /* html */ `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 40"><text x="150" y="28" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif" font-size="24" font-weight="700" fill="currentColor">TripleSOC Dashboard</text></svg>`;
  }
}
